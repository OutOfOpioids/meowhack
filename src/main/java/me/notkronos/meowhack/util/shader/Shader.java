...
public abstract class Shader {
    ...
    public Shader(final String fragmentShader) {
        ...
        try (final InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/meowhack/shaders/vertex.vert")) {
        ...
        try (final InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/meowhack/shaders/frag/" + fragmentShader)) {
